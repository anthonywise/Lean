...
namespace QuantConnect.Securities
{
    ...
    public class DynamicSecurityData : IDynamicMetaObjectProvider
    {
        ...
        [Obsolete("DynamicSecurityData is a view of the SecurityCache properties can not be set")]
        public object SetProperty(string name, Lazy<object> value)
        {
            throw new InvalidOperationException("DynamicSecurityData is a view of the SecurityCache properties can not be set");
        }
