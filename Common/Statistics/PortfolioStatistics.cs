...
<<<<<<< HEAD
        ...
        /// </summary>
        [JsonConverter(typeof(JsonRoundingConverter))]
        public decimal SQNEstimateRaw { get; set; }

        /// <summary>
        /// SQN100 based on AverageLoss
        /// </summary>
        [JsonConverter(typeof(JsonRoundingConverter))]
        public decimal SQNEstimate100 { get; set; }
...
<<<<<<< HEAD
                ...
                var prevAverageTradeProfitLoss = averageTradeProfitLoss;
                averageTradeProfitLoss += (tradeProfitLoss - averageTradeProfitLoss) / trades;
